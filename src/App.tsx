...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="relative h-40 md:h-48 overflow-hidden">
                  ...
                  />
                  <div className="absolute top-4 left-4 bg-[#2c2f4c] bg-opacity-80 rounded-full p-3">
      ...
      <section className="below-fold py-12 md:py-16 lg:py-20 bg-[#a8e3f4]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
      ...
      <footer className="below-fold bg-gray-900 text-white py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="text-2xl md:text-3xl font-bold mb-3 md:mb-4 text-[#e4bdc7]">A I R M A N A</div>
